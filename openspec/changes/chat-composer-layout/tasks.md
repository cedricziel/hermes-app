...
- [ ] 1.1 Write failing widget tests for `ChatComposer` (bottom row order, send enabled by text or attachments, Enter and Shift+Enter, attach callback, hint while replying), then build `lib/src/chat/widgets/chat_composer.dart` until they pass

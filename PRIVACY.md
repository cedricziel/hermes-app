...
- the app version, whether it is a release build, and the platform: the system (iOS, macOS or Android), on Apple systems its major and minor version, and whether the device is a phone, a tablet or a desktop
